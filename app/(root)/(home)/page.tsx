      ...
      <section className='flex items-center max-width flex-col-reverse tablet:flex-row mb-10'>
        ...
        <div className='tablet:w:2/3 mt-10 tablet:mt-0'>
          <div className='flex flex-col gap-3 items-center tablet:items-start max-w-2xl text-center tablet:text-left'>
            ...
            <h1 className='text-grey'>Bienvenido a mi Portafolio</h1>
            <p className='text-gray-600'>Soy un apasionado por la programación y el desarrollo de software, y estoy emocionado por aprender y crecer en este campo.</p>
          </div>
        ...
        {/*Lado derecho*/}
        <div className='relative  w-full tablet:w-1/3 h-[200px] tablet:h-[320px] rounded-b-2xl overflow-hidden mt-5 tablet:ml-14'>
